    ...
    >
      <div className="max-w-6xl mx-auto">
              ...
              <div className="relative bg-white dark:bg-dark-800 p-8 rounded-2xl shadow-lg backdrop-blur-sm border border-gray-100 dark:border-dark-700 h-full flex flex-col transform transition-all duration-300 hover:translate-y-[-8px] hover:shadow-xl">
                ...
                <div className="mt-auto">
                  ...
                  <div className="mt-4 flex justify-between items-center">
                    ...
                    <div
                      className="w-8 h-8 rounded-full flex items-center justify-center bg-primary-500/10 text-primary-500 dark:text-primary-400 group-hover:bg-primary-500 group-hover:text-white transition-all duration-300 cursor-pointer"
                      onClick={openModal}
                    >
        ...
        >
          <button
            onClick={openModal}
            className="px-8 py-3 bg-gradient-to-r from-primary-500 to-accent-500 text-white font-medium rounded-full hover:shadow-lg hover:shadow-primary-500/20 transition-all duration-300 transform hover:translate-y-[-2px]"
          >
